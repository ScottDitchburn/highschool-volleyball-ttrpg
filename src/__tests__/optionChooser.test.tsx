...
function charWith(selectedAbilities: SelectedAbility[]): Character {
  return {
    ...
    name: 'Chooser',
    skills: allStats(3.5),
    // Synthetic fixture: explicit cm values; modifier for height roll 15 is -2 (v.3 table).
    physical: { heightRoll: 15, verticalRoll: 10, heightCm: 180, verticalModifier: -2, verticalCm: 75 },
    selectedAbilities,
  };
}
